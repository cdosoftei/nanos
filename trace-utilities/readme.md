...
bargraph showing function latencies for all functions in the trace file. This bar graph
will be rendered in your default web browser, e.g.,
  <p align="center">
...
__very__ long latencies (e.g., `kernel_sleep`, `run_thread`). Data for a particular
function can be disabled by clicking it in the function list on the right, creating
